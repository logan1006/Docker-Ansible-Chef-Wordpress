...
knife bootstrap ec2-18-191-145-233.us-east-2.compute.amazonaws.com --ssh-user root --sudo --identity-file ~/.ssh/id_rsa.pub --node-name ec2-18-198-140-298.us-east-2.compute.amazonaws.com
